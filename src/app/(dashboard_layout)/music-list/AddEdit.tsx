...
export default function AddEdit() {
  ...
  } = useForm<FormType>({ defaultValues: { title: '', description: '', status: 'active', category: '', short_description: '', image: '',audio:'' } })
 ...
 const { get: getCategory, isLoading: categoryLoading } = FireApi()
  ...
  useEffect(() => {
    ...
    const res = await getCategory('categories', [{ field: 'type', operator: '==', value: 'music' }])
    let data = []
    if (res.data) {
